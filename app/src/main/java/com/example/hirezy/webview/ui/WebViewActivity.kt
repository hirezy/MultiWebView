...
import com.example.hirezy.webview.utils.CheckNetwork
...
import com.example.hirezy.webview.config.*
...
class WebViewActivity : AppCompatActivity(), IWebPageView {
    ...
    private fun initTitle() {
        ...
        val rl_web_container = findViewById<RelativeLayout>(R.id.rl_web_container)
        webView = WebView(this)
        mProgressBar = WebProgress(this)
        mProgressBar!!.visibility = View.GONE
        rl_web_container.addView(
            webView,
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.actionbar_open -> WebTools.openLink(this@WebViewActivity, webView!!.url)
