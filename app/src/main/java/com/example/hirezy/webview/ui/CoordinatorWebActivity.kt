...
import com.example.hirezy.webview.utils.StatusBarUtil
import androidx.core.content.ContextCompat
import android.widget.Toast
import com.example.hirezy.webview.config.MyJavascriptInterface
import android.content.Intent
import com.example.hirezy.webview.MainActivity
...
import com.example.hirezy.webview.view.NestedScrollWebView
 ...
 */
class CoordinatorWebActivity : AppCompatActivity() {
    // 网页链接
    ...
    private val onByWebClientCallback: OnByWebClientCallback = object : OnByWebClientCallback() {
        ...
        override fun isOpenThirdApp(url: String): Boolean {
            // 处理三方链接
            Log.e("---url", url)
            return handleThirdApp(this@CoordinatorWebActivity, url)
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.actionbar_share -> {
                ...
                WebTools.share(this@CoordinatorWebActivity, shareText)
            }
            R.id.actionbar_cope -> {
    ...
    companion object {
        ...
        fun loadUrl(mContext: Context, url: String?, title: String?, state: Int) {
            val intent = Intent(mContext, CoordinatorWebActivity::class.java)
